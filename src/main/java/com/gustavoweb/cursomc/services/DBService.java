...
import com.gustavoweb.cursomc.domain.enums.Perfil;
...
public class DBService {
	...
	public void instanciateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Gustavo Morais", "sprigemailtestapi@gmail.com", "46329223823",
				TipoCliente.PESSOAFISICA, pe.encode("boss"));
		cli1.addPerfil(Perfil.ADMIN);

		Cliente cli2 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912377",
		...
		Endereco e3 = new Endereco(null, "Rua Hermes Fontes", "81", "Sala 800", "Centro", "38777012", cli1, c2);
